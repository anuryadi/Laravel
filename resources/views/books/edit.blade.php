...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            <form action="{{route('books.update', ['id'=>$book->id])}}"
                class="p-3 shadow-sm bg-white-lighter"
                method="POST"
                ...
                <small class="text-murted">Current Cover</small><br>
                @if ($book->cover)
                ...
                <input type="text" name="slug" class="form-control"
                    value="{{$book->slug}}" placeholder="enter-a-slug">
                <br>
